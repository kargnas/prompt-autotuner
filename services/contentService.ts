...
const PROMPT_GUIDE_CONTENT = `# Prompt design strategies (2025-11-22 updated)
...
const XML_GUIDE_CONTENT = `# Prompt Engineering Guidelines
...
/**
 * Returns the prompt strategies guide.
 */
export function getPromptGuide(): string {
    return PROMPT_GUIDE_CONTENT;
}

/**
 * Fetches the XML prompting guide from the server.
 */
export function getXmlPromptingGuide(): string {
    return XML_GUIDE_CONTENT;
}
